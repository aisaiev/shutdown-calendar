    ...
    <div class="rounded-xl border bg-card text-card-foreground shadow">
      <div class="flex flex-col space-y-1.5 p-6">
        <h2 class="font-semibold leading-none tracking-tight text-lg">
          Визначити свою чергу за адресою
        </h2>
      </div>
      <div class="p-6 pt-0">
        <div class="space-y-4">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="space-y-2 relative">
              ...
              <div
                id="street-results"
                class="hidden absolute z-10 w-full mt-2 rounded-md border bg-card shadow-lg max-h-60 overflow-y-auto"
              ></div>
            </div>
            <div class="space-y-2 relative">
          ...
          <div
            id="group-result"
            class="hidden p-4 rounded-lg bg-primary/5 border border-primary/10"
          >
